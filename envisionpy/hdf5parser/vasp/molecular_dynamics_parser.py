...
import numpy as np
import h5py
from h5writer import _write_basis, _write_scaling_factor, _write_coordinates, _write_md
...
#testar enbart med dena xdatcar fil... hör ej ihop med outcar.
    ...
    if has_md_ok is True:
        with poscar_file_path.open("r") as f:
            ...
            _write_basis(hdf5_file_path, basis)
            _write_scaling_factor(hdf5_file_path, scaling_factor)
            _write_coordinates(
                hdf5_file_path,
                atoms,
                coords_list,
